...
$(function() {
	...
	describe("The Menu", function() {
		 ...
		 */
		it('hide the menu elements by default', function() {
		...
		it('click menu icon and get menu elements', function() {
			menu_icon.click();
	...
	describe("new feed selection", function() {
		...
		it("initial entries and final entries are not same", function() {
